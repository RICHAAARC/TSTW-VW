"""
文件用途：提供阶段 2 tensor-runtime VAE backend 实现。
File purpose: Provide the tensor-runtime VAE backend implementation for the stage-two scaffold.
