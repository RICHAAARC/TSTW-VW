...
| --- | --- | --- | --- |
| constraints | 36 | 164 | default governance checks |
| functional | 52 | 262 | default quick behavior checks |
...
| `tests/constraints/test_trajectory_aware_sampling_contract.py` | 9 | constraints | `constraint`, `unit` | 9 | no | no | no | 验证 trajectory-aware sampling probe 的配置与边界契约。 |
