...
| --- | --- | --- | --- |
| constraints | 36 | 160 | default governance checks |
| functional | 48 | 250 | default quick behavior checks |
...
| `tests/constraints/test_trajectory_aware_sampling_contract.py` | 5 | constraints | `constraint`, `unit` | 5 | no | no | no | 验证 trajectory-aware sampling probe 的配置与边界契约。 |
