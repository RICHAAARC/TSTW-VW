...
| --- | --- | --- | --- |
| constraints | 36 | 167 | default governance checks |
| functional | 55 | 271 | default quick behavior checks |
...
| `tests/constraints/test_trajectory_aware_sampling_contract.py` | 12 | constraints | `constraint`, `unit` | 12 | no | no | no | 验证 trajectory-aware sampling probe 的配置与边界契约。 |
