...
| functional | 57 | 277 | default quick behavior checks |
...
| `tests/constraints/test_trajectory_aware_sampling_contract.py` | 13 | constraints | `constraint`, `unit` | 13 | no | no | no | 验证 trajectory-aware sampling probe 的配置与边界契约。 |
...
| `tests/functional/test_trajectory_aware_sampling_backend_adapter_scaffold.py` | 3 | functional | `quick` | 3 | no | no | no | 文件用途: 验证 trajectory-aware sampling 的 backend adapter scaffold。 |
| `tests/functional/test_trajectory_aware_sampling_backend_connection_contract.py` | 3 | functional | `quick` | 3 | no | no | yes | 文件用途: 验证 trajectory-aware sampling 的 backend connection contract。 |
| `tests/functional/test_trajectory_aware_sampling_backend_integration_decision.py` | 3 | functional | `quick` | 3 | no | no | no | 文件用途: 验证 trajectory-aware sampling 的后端集成决策 gate。 |
...
| `tests/functional/test_trajectory_aware_sampling_probe_workflow_result_gate.py` | 2 | functional | `quick` | 2 | yes | no | yes | 文件用途: 验证 trajectory-aware sampling notebook helper 的 result gate 写出流程。 |
...
| `tests/functional/test_trajectory_aware_sampling_runtime_interface_scaffold.py` | 3 | functional | `quick` | 3 | no | no | no | 文件用途: 验证 trajectory-aware sampling 真实 GPU runtime 接口脚手架。 |
