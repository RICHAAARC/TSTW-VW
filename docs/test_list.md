...
| --- | --- | --- | --- |
| constraints | 36 | 161 | default governance checks |
| functional | 49 | 253 | default quick behavior checks |
...
| `tests/constraints/test_trajectory_aware_sampling_contract.py` | 6 | constraints | `constraint`, `unit` | 6 | no | no | no | 验证 trajectory-aware sampling probe 的配置与边界契约。 |
