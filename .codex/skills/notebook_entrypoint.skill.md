...
- If the formal runner GPU profiler produces `not_sampled`, the run notebook may execute a lightweight GPU profiling smoke fallback and must label it separately from the full runner profile.
