...
Applies to future release boundary definitions, extraction constraints, and current-stage release prohibitions.
...
- Current-stage prohibition against release directory creation.
