...
from experiments.protocol_skeleton.ablation_runner import AblationRunner
...
@pytest.mark.smoke
def test_protocol_skeleton_table_rebuild_preserves_tables_digest(tmp_path: Path) -> None:
