...
REAL_VIDEO_VAE_LATENT_REQUIRED_PATHS = {
    ...
    "real_video_vae_latent_runtime_profile_root": "scripts/profile_runtime",
    "real_video_vae_latent_capture_environment_profile_module": "scripts/profile_runtime/capture_colab_environment.py",
    "real_video_vae_latent_run_timing_profile_module": "scripts/profile_runtime/profile_run_timing.py",
    "real_video_vae_latent_run_timing_summary_module": "scripts/profile_runtime/summarize_run_timing.py",
    "real_video_vae_latent_gpu_profile_module": "scripts/profile_runtime/profile_gpu_runtime.py",
    "real_video_vae_latent_gpu_profile_summary_module": "scripts/profile_runtime/summarize_gpu_profile.py",
    "real_video_vae_latent_run_scale_estimator_module": "scripts/profile_runtime/estimate_real_video_vae_latent_run_scale.py",
    "real_video_vae_latent_progress_watcher_module": "scripts/profile_runtime/watch_real_video_vae_latent_progress.py",
    "real_video_vae_latent_drive_io_profile_module": "scripts/profile_runtime/profile_drive_io.py",
    "real_video_vae_latent_runtime_parameter_recommendation_module": "scripts/profile_runtime/recommend_runtime_parameters.py",
    "real_video_vae_latent_run_failure_summary_module": "scripts/check_results/summarize_run_failures.py",
    ...
    "real_video_vae_latent_runtime_profile_workflow_helper": "paper_workflow/notebook_utils/runtime_profile_workflow.py",
    "real_video_vae_latent_run_timing_workflow_helper": "paper_workflow/notebook_utils/run_timing_workflow.py",
