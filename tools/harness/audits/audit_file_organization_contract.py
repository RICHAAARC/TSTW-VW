...
REQUIRED_PATHS = {
    ...
    "runtime_profile_scripts_root": "scripts/profile_runtime",
    "runtime_profile_capture_environment_script": "scripts/profile_runtime/capture_colab_environment.py",
    "runtime_profile_run_timing_script": "scripts/profile_runtime/profile_run_timing.py",
    "runtime_profile_run_timing_summary_script": "scripts/profile_runtime/summarize_run_timing.py",
    "runtime_profile_gpu_profiler_script": "scripts/profile_runtime/profile_gpu_runtime.py",
    "runtime_profile_gpu_summary_script": "scripts/profile_runtime/summarize_gpu_profile.py",
    "runtime_profile_run_scale_script": "scripts/profile_runtime/estimate_real_video_vae_latent_run_scale.py",
    "runtime_profile_progress_watcher_script": "scripts/profile_runtime/watch_real_video_vae_latent_progress.py",
    "runtime_profile_drive_io_script": "scripts/profile_runtime/profile_drive_io.py",
    "runtime_profile_recommendation_script": "scripts/profile_runtime/recommend_runtime_parameters.py",
    "runtime_profile_failure_summary_script": "scripts/check_results/summarize_run_failures.py",
    "runtime_profile_workflow_helper": "paper_workflow/notebook_utils/runtime_profile_workflow.py",
    "run_timing_workflow_helper": "paper_workflow/notebook_utils/run_timing_workflow.py",
